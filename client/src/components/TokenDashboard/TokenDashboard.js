...
const TokenDashboard = ({topOwnersLoading, tokenPricesLoading}) => {
  ...
  useEffect(() => {
    const shouldFetchTokenData = !globalDataCache.token || globalDataCache.token.tokenAddress !== tokenAddress;
                ...
                <div class="col-lg-4">
                    ...
                    <ul className="table-list">
                        <li>
                            ...
                            <div className="right">{globalDataCache.token.tokenMetadata.total_supply_formatted}</div>
                        </li>
                        <li>
                            <div className="left">Fully Diluted Valuation</div>
                            <div className="right">${globalDataCache.token.tokenMetadata.fdv}</div>
                        </li>
                        <li>
                            <div className="left">Token Age</div>
                            <div className="right">{moment().diff(globalDataCache.token.tokenMetadata.created_at, 'days')} days</div>
                        </li>
                        <li>
                            <div className="left">Date Created</div>
                            <div className="right">{moment(globalDataCache.token.tokenMetadata.created_at).format('YYYY-MM-DD')}</div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div className="right copy-container">
                                ...
                                <CopyToClipboard valueToCopy={globalDataCache.token.tokenAddress}>
                                <button></button>
                                </CopyToClipboard>
                            </div>
                        </li>
                        <li>
                            ...
                            <div className="right">{globalDataCache.token.tokenMetadata.name}</div>
                        </li>
                        <li>
                            <div className="left">Symbol</div>
                            <div className="right">{globalDataCache.token.tokenMetadata.symbol}</div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div className="right">{globalDataCache.token.tokenMetadata.decimals}</div>
                        </li>
                ...
                <div className="col-lg-8">
                    ...
                    <>
                        ...
                        <div className="canvas">
                            {priceLoading
                                ? <Loader />
                                : <TokenPriceChart chartArray={globalDataCache.token.tokenPrices} direction={globalDataCache.token.tokenPriceStats.direction}/>
                            }
                ...
                <div>
                    <Nav tabs>
                        ...
                        <NavItem>
                            <NavLink
                                ...
                                onClick={() => { toggle('4'); }}>Profitable Wallets
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink
                                className={classnames({ active: activeTab === '5' })}
                                onClick={() => { toggle('5'); }}>Token Swaps
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink
                                className={classnames({ active: activeTab === '6' })}
                                onClick={() => { toggle('6'); }}>Token Pairs
                            </NavLink>
                        </NavItem>
                    </Nav>
                    ...
                    <TabContent activeTab={activeTab}>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {owner.owner_address_label && (
                                            <div>{owner.owner_address_label.replace(/ \d+$/, '')}</div>
                                        )}
                                    </td>
                                    <td>
                                        <div>{owner.is_contract ? "Contract" : "Wallet"}</div>
                                    </td>
                                    <td>
                                    
                                        <div>{Number(owner.balance_formatted).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</div>
                                    </td>
                                    <td>
                                        <div>{Number(owner.percentage_relative_to_total_supply).toFixed(2)}%</div>
                                    </td>
                                    <td>
                                        <div>${Number(owner.usd_value).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</div>
                                    </td>
                                </tr>
                            ))}
                            </tbody>
                        ...
                        <TabPane tabId="2">
                            ...
                            {!topOwnersLoading && globalDataCache.token.topTokenOwners && (
                                <>  
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <div className="holders-summary wallet-card">
                                                <div className="title">🐳 Whale Summary</div>
                                                <div>The top 10 holders of {globalDataCache.token.tokenMetadata.name} hold <span>{utilities.formatPriceNumber(globalDataCache.token.totalBalance)}</span> {globalDataCache.token.tokenMetadata.symbol}</div>
                                                <div>This represents <span>{globalDataCache.token.totalPercentage.toFixed(2)}%</span> of the Total Supply ({globalDataCache.token.tokenMetadata.total_supply_formatted}), and is currently worth <span>${utilities.formatPriceNumber(globalDataCache.token.totalUsd)}</span></div>
                                            </div>
                                        </div>
                                        <div className="col-lg-6">
                                            <div className="common-tokens wallet-card">
                                            <div className="title">💸 Common Tokens</div>
                                                <div>Common tokens that at least 2 of the 10 ten holders also hold</div>
                                                <div className="token-balances-mini">
                                                {globalDataCache.token.commonTokens && globalDataCache.token.commonTokens.map((token, index) => (
                                                    <>
                                                        <UncontrolledTooltip target={`x-${token.tokenDetails.token_address}-${index}`} placement="top" className="popup">
                                                            <div className="token-popup">
                                                                <div className="token-title">
                                                                    <TokenLogo tokenImage={token.tokenDetails.logo} tokenName={token.tokenDetails.name}/>
                                                                    <div>{token.tokenDetails.name}</div>
                                                                </div>
                                                                <div className="popup-group">
                                                                    <div className="heading">Held By</div>
                                                                    <div className="value">{token.count} out of 10</div>
                                                                </div>
                                                            </div>
                                                        </UncontrolledTooltip>
                                                        <div id={`x-${token.tokenDetails.token_address}-${index}`}>
                                                            <TokenLogo  tokenImage={token.tokenDetails.logo} tokenName={token.tokenDetails.name}/>
                                                            </div>
                                                    </>
                                    ...
                                    <Table responsive>
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                {globalDataCache.token.tokenMetadata.symbol} Percentage Total Supply
                                                </th>
                                                <th>
                                                    Top Tokens Held
                                                </th>
                                        ...
                                        <tbody>
                                        {globalDataCache.token.topTokenOwners && globalDataCache.token.topTokenOwners.map((owner, index) => (
                                            <tr>
                                                <th scope="row">
                                                    {index+1}
                                                </th>
                                                <td>
                                                    <div>{owner.owner.owner_address}</div>
                                                    {owner.owner.owner_address_label && (
                                                        <div>{owner.owner.owner_address_label.replace(/ \d+$/, '')}</div>
                                                    )}
                                                </td>
                                                <td>
                                                    <div>{Number(owner.owner.percentage_relative_to_total_supply).toFixed(2)}%</div>
                                                    <div>${Number(owner.owner.usd_value).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</div>
                                                </td>
                                                <td>
                                                    <div className="token-balances-mini">
                                                        {owner.balanceData.map((token, index) => (
                                                            <>
                                                                <UncontrolledTooltip target={`a${owner.owner.owner_address}-token-${index}`} placement="top" className="popup">
                                                                    <div className="token-popup">
                                                                        <div className="token-title">
                                                                            <TokenLogo key={`${owner.owner_address} ${token.symbol}`} tokenImage={token.logo} tokenName={token.name} onClick={() => handleTokenClick(token)}/>
                                                                            <div>{token.name}</div>
                                                                        </div>
                                                                        <div className="popup-group">
                                                                            <div className="heading">Current Price</div>
                                                                            <div className="value">${token.usd_price}</div>
                                                                        </div>
                                                                        <div className="popup-group">
                                                                            <div className="heading">Amount Held</div>
                                                                            <div className="value">{token.balance_formatted}</div>
                                                                        </div>
                                                                        <div className="popup-group">
                                                                            <div className="heading">Current Value</div>
                                                                            <div className="value">{token.usd_value}</div>
                                                                        </div>
                                                                        <div className="popup-group">
                                                                            <div className="heading">Portfolio Percentage</div>
                                                                            <div className="value">{token.portfolio_percentage}%</div>
                                                                        </div>
                                                                    </div>
                                                                </UncontrolledTooltip>
                                                                <div id={`a${owner.owner.owner_address}-token-${index}`}>
                                                ...
                                                <td>
                                                    {owner.networthData.total_networth_usd ? `$${utilities.formatPriceNumber(owner.networthData.total_networth_usd)}` : `$0`}
                                                </td>
                                            </tr>
                                        ))}
                                        </tbody>

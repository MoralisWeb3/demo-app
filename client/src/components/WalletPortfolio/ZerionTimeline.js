                ...
                <div className="history-left">
                  ...
                  <div className="history-category">
                    ...
                    <div className="timestamp">
                      {moment(item.block_timestamp).format("HH:mm A")}
                    </div>
                  </div>
                </div>
                    ...
                    item.category === "airdrop" ? (
                      <>
                        <div>
                          ...
                          {item.nft_transfers &&
                            item.nft_transfers.filter(
                              (item) => item.direction === "send"
                            ).length > 0 && (
                              <div className="token-details send">
                                <div>
                                  <TransactionImage
                                ...
                                <div>
                                  {item.nft_transfers.filter(
                                    ...
                                    <>
                                      -1{" "}
                                      {item.nft_transfers[0].normalized_metadata
                                        ? item.nft_transfers[0]
                                            .normalized_metadata.name
                                        : `NFT #${item.nft_transfers[0].token_id}`}
                                    </>
                                  )}
                                </div>
                              </div>
                      ...
                      <>
                        <div className="token-details">
                          {item.summary} {item.method_label}
                        </div>
                      </>
                    )}
                  </div>
                                ...
                                <div className="token-details receive">
                                  ...
                                  <div className="received">
                                    {token.value_formatted ? (
                                      <>
                                        +
                                        {Number(token.value_formatted).toFixed(
                                          2
                                        )}{" "}
                                        {token.token_symbol}
                                      </>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        {item.to_address_entity
                          ...
                          ? item.to_address_label
                          : utilities.shortAddress(item.to_address)}
                      </div>
                    </>
                  ) : item.category === "receive" ||
                    item.category === "nft receive" ||
                    ...
                    <>
                      ...
                      <div>
                        {item.from_address_entity_logo ? (
                          <img
                            src={`${item.from_address_entity_logo}`}
                            alt="profile"
                          />
                        ) : (
                          <img
                            src={`https://api.dicebear.com/7.x/identicon/svg?backgroundColor=b6e3f4&seed=${item.from_address}`}
                            alt="profile"
                          />
                        )}
                        ...
                        {item.from_address_entity
                          ...
                          ? item.from_address_label
                          : utilities.shortAddress(item.from_address)}
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <div>
                        {item.to_address_entity_logo ? (
                          <img
                            src={`${item.to_address_entity_logo}`}
                            alt="profile"
                          />
                        ) : (
                          <img

...
const Overview = () => {
  ...
  const fetchProfile = (chain) => {
    setLoading(true);
    fetch(
      `${process.env.REACT_APP_API_URL}/api/wallet/profile?wallet=${globalDataCache.walletAddress}&chain=${chain}`
    )
      .then((response) => {
        if (!response.ok) {
      ...
      .then((data) => {
        ...
        if (!globalDataCache.approvalsLoaded) {
          fetchApprovals(globalDataCache.walletAddress);
        }
        ...
        <div className="page-header">
          <h2>
            ...
            <div className="domains">
              <div>
                <Link
                  to={`https://etherscan.io/address/${globalDataCache.walletAddress}`}
                  target="_blank"
                >
                  <img
                    className="etherscan"
              ...
              {globalDataCache.profile.ens && (
                <div id="ens-domain">
                  <UncontrolledTooltip target={`ens-domain`} placement="top">
                    ENS Domain
                  </UncontrolledTooltip>
                  <img src="/images/ens-logo.avif" alt="ens" />
                  {globalDataCache.profile.ens}
                </div>
              )}
              ...
              {globalDataCache.profile.unstoppable && (
                <div id="ud-domain">
                  <UncontrolledTooltip target={`ud-domain`} placement="top">
                    Unstoppable Domain
                  </UncontrolledTooltip>
                  <img src="/images/ud-logo.svg" alt="unstoppable" />
                  {globalDataCache.profile.unstoppable}
                </div>
              )}
            </div>
                  ...
                  <div className="profile-intro">
                    ...
                    <div>
                      ...
                      <div className="big-value networth copy-container">
                        {utilities.shortAddress(globalDataCache.walletAddress)}
                        <CopyToClipboard
                          valueToCopy={globalDataCache.walletAddress}
                        >
                          <button></button>
                        </CopyToClipboard>
                      </div>
                  ...
                  <div className="big-value">
                    ...
                    {globalDataCache.networth
                      ? utilities.formatPriceNumber(
                          Number(globalDataCache.networth).toFixed(0)
                        )
                      : "0"}
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="heading">
                    First seen
                    {globalDataCache?.profile?.isFresh && (
                      <span className="fresh">FRESH</span>
                    )}
                  </div>
                  <div className="big-value">
                    {moment(globalDataCache.profile.firstSeenDate).fromNow()}
                  </div>
                </div>
                ...
                <div className="col-lg-4">
                  ...
                  <div className="big-value">
                    {moment(globalDataCache.profile.lastSeenDate).fromNow()}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="row">
          ...
          {!loading && globalDataCache.stats && (
            <div className="col-lg-4">
              <div className="wallet-card">
                <div className="title">
                  Tokens ({globalDataCache?.token_balances.length})
                </div>

                {globalDataCache.token_balances &&
                  globalDataCache.token_balances.length > 0 && (
                    <>
                            ...
                            .map((token) => (
                              <li key={token.token_address}>
                                ...
                                <div className="token-balance">
                                  {Number(token.balance_formatted).toFixed(2)}
                                </div>
                                <div className="token-balance">
              ...
              <div className="wallet-card">
                ...
                <div className="row nft-summary">
                  <div className="col-lg-6">
                    ...
                    <div className="big-value">
                      {globalDataCache.stats.collections}
                    </div>
                  </div>
              ...
              <div className="wallet-card">
                ...
                <div className="row">
                  <div className="col-lg-4">
                    <div className="big-value">
                      {globalDataCache?.stats?.transactions?.total}
                    </div>
                  ...
                  <div className="col-lg-4">
                    <div className="big-value">
                      {globalDataCache?.stats?.token_transfers?.total}
                    </div>
                  ...
                  <div className="col-lg-4">
                    <div className="big-value">
                      {globalDataCache?.stats?.nft_transfers?.total}
                    </div>
              ...
              <div className="wallet-card">
                ...
                <div class="badges">
                  <UncontrolledTooltip target={`badge-whale`} placement="top">
                    Holds more than 100 ETH
                  </UncontrolledTooltip>
                  <div
                    id="badge-whale"
                    className={
                      globalDataCache.profile.isWhale
                        ? `badge-card active`
                        : `badge-card`
                    }
                  >
                  ...
                  <UncontrolledTooltip target={`badge-early`} placement="top">
                    Pre-2017 Wallet
                  </UncontrolledTooltip>
                  <div
                    id="badge-early"
                    className={
                      globalDataCache.profile.earlyAdopter
                        ? `badge-card active`
                        : `badge-card`
                    }
                  >
                  ...
                  <UncontrolledTooltip target={`badge-chains`} placement="top">
                    Active on multiple chains
                  </UncontrolledTooltip>
                  <div
                    id="badge-chains"
                    className={
                      globalDataCache.profile.multiChainer
                        ? `badge-card active`
                        : `badge-card`
                    }
                  >
                  ...
                  <UncontrolledTooltip target={`badge-tokens`} placement="top">
                    Holds more than 20 tokens
                  </UncontrolledTooltip>
                  <div
                    id="badge-tokens"
                    className={
                      globalDataCache.profile.speculator
                        ? `badge-card active`
                        : `badge-card`
                    }
                  >
                  ...
                  <UncontrolledTooltip target={`badge-nfts`} placement="top">
                    Holds more than 20 NFTs
                  </UncontrolledTooltip>
                  <div
                    id="badge-nfts"
                    className={
                      globalDataCache.profile.collector
                        ? `badge-card active`
                        : `badge-card`
                    }
                  >
                  ...
                  <UncontrolledTooltip target={`badge-age`} placement="top">
                    Wallet Age
                  </UncontrolledTooltip>
